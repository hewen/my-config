...
before packages are loaded."
  ...
  (add-hook 'php-mode-hook 'php-enable-codeigniter-coding-style)

  (defun java-coding-style ()
    (interactive)
    (setq indent-tabs-mode t
          fill-column 80
          tab-width 4
  ...
  (add-hook 'kotlin-mode-hook 'format-all-mode)
  )
